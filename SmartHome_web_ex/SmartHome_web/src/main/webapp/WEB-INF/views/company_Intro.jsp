        ...
        <section class="bg-light" id="services">
            <div class="container px-4">
                <div class="row gx-4 justify-content-center">
                    <div class="col-lg-8">
                        <h2>제공되는 서비스</h2>
                        <p class="lead">eazy 홈은 시간, 장소에 구애 받지 않고 언제 어디서나 가스, 조명, 외부인 통제를 하는 등 가정환경을 편리하게 관리하는 것으로 각종 센서, 음성과 애플리케이션 등을 관리해줍니다. 각 센서들은 자동화 시스템으로 특별한 관리가 필요하지 않지만, 사용자가 원한다면 장소에 구애하지 않고 애플리케이션을 통하여 안전하게 수동 관리가 가능합니다.</p>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section id="contact">
            <div class="container px-4">
                <div class="row gx-4 justify-content-center">
                    <div class="col-lg-8">
                        <h2>홈페이지</h2>
                        <p class="lead">현재 홈페이지에서는 판매와 문의, 각종 설명사항과 게시판이 있으니 많은 이용바랍니다. 저희 직원들은 개발한 재품들을 항상 살펴보고 구매해주신 분들의 의견을 적극 피드백하고있습니다. 또한 인기상품을 추려 더 나은 기능의 재품을 개발하고 있으니, 고객님들의 많은 의견을 자유롭게 재공해 주시기 바랍니다.</p>
                    </div>
                </div>
            </div>
        </section>
